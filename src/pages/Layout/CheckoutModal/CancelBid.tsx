  ...
  return (
    <div className="flex flex-col w-full">
      <div className="flex flex-col p-5 gap-y-[25px]  border-gray">
        <CheckoutProcessItem status={transactionStatus.confirmTransaction} title="Confirm cancelling your bid" description="Proceed in your wallet and confirm cancelling bid." />
        ...
        <CheckoutProcessItem status={transactionStatus.purchaseConfirm} title="Your bid is canceled!" description="Your bid succesfully canceled." />
        {bidBalanceUpdated && (
...
const CancelBid = ({ show, onClose }: { show: boolean; onClose: any }) => {
  ...
  return (
    <Modal className="checkout" title="Cancel Your Bid" show={show} onClose={onClose} footer={<Footer approved={approved} />}>
