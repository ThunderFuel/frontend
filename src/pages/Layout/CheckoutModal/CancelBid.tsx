...
const checkoutProcessTexts = {
  title1: "Confirm cancelling your bid",
  description1: "Proceed in your wallet and confirm cancelling bid.",
  title2: "Wait for approval",
  description2: "Waiting for transaction to be approved",
  title3: "Your bid is canceled!",
  description3: "Your bid succesfully canceled.",
};
...
const CancelBid = ({ show, onClose }: { show: boolean; onClose: any }) => {
  ...
  return (
    <Modal backdropDisabled={true} className="checkout" title="Cancel Your Bid" show={show} onClose={onClose} footer={<Footer approved={approved} onClose={onClose} />}>
