  ...
  return (
    <div className="flex flex-col w-full">
      <div className="flex flex-col p-5 gap-y-[25px]  border-gray">
        <CheckoutProcessItem status={transactionStatus.confirmTransaction} title="Confirm your canceling auction" description="Proceed in your wallet and confirm canceling auction." />
        ...
        <CheckoutProcessItem status={transactionStatus.purchaseConfirm} title="Your auction is canceled!" description="Your auction succesfully canceled." />
      </div>
    </div>
  );
};
