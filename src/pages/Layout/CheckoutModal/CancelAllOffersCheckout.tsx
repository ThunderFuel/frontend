...
const checkoutProcessTexts = {
  ...
  title3: "Your offers are canceled!",
  description3: "Your offers are succesfully canceled.",
};
...
const CancelAllOffers = ({ show, onClose }: { show: boolean; onClose: any }) => {
  ...
  return (
    <Modal backdropDisabled={true} className="checkout" title="Cancel All Offers" show={show} onClose={onClose} footer={<Footer approved={approved} onClose={onClose} />}>
