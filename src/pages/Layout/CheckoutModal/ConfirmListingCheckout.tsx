  ...
  return (
    <div className="flex flex-col w-full">
      <div className="flex flex-col p-5 gap-y-[25px]  border-gray">
        <CheckoutProcessItem status={transactionStatus.confirmTransaction} title="Confirm your listing" description="Proceed in your wallet and confirm the listing." />
        ...
        <CheckoutProcessItem status={transactionStatus.purchaseConfirm} title="Your NFT listed!" description="Congrats, your NFT succesfully listed." />
      </div>
    </div>
  );
};
