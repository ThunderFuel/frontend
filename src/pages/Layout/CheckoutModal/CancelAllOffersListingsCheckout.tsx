...
const CancelAllOffersListingsCheckout = ({ show, onClose }: { show: boolean; onClose: any }) => {
  ...
  return (
    <Modal
      ...
      title={approved || !startTransaction || isFailed ? "" : "Cancel All Offers and Listings"}
    ...
    >
      {!startTransaction ? (
        ...
        <div className="flex flex-col w-full gap-5 p-5">
          <Approved title="All Offers and Listings Cancelled Successfully!" description="All of your offers and listings have been cancelled." />
        </div>
      ) : (
