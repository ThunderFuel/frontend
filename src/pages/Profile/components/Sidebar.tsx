          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              <div className="flex flex-col gap-2 px-4 py-3.5 text-gray-light bg-bg border border-gray rounded-md">
                ...
                <h4 className="text-h4 text-white text-right mt-20">{numberFormat(userInfo.tokens?.length)}</h4>
              </div>
              <div className="flex flex-col gap-2 px-4 py-3.5 text-gray-light bg-bg border border-gray rounded-md">
            ...
            <BoxWithIcon icon={IconQuarry} className="mt-2">
              <div className="text-headline-02 text-gray-light uppercase">LAST offer</div>
              0.99 ETH Bid placed by 09x910
            </BoxWithIcon>
            <BoxWithIcon icon={IconQuarry} className="mt-2">
              <div className="text-headline-02 text-gray-light uppercase">LAST ACTIVITY</div>
              Minted CloneX #2750
            </BoxWithIcon>
          </div>
        </div>
