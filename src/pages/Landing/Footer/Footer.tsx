    ...
    <div className="lg:container">
      <div className=" flex flex-col bg-gray-dark lg:justify-center  bg-[#1a1a1a] w-full pt-10 pb-5">
        <div className="lg:flex lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap  items-center gap-x-[55px] lg:gap-x-[80px] gap-y-[28px] lg:pt-3 lg:flex-nowrap pl-5 lg:pl-10">
            <div className="flex flex-col w-[140px] h-[126px] gap-3">
        ...
        <div className="h-[1px] bg-gray mt-[40px] mb-[20px] "></div>
        <div className="flex justify-between pl-5 lg:pl-10 lg:pr-10">
          <IconThunder />
