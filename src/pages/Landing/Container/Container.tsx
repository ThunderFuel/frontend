  ...
  return (
    <div className="border-t border-gray">
      <div className="container flex flex-col items-center pt-[150px]">
        ...
        <div className="flex flex-col-reverse bg-no-repeat pb-[32px] h-[532px] lg:h-[292px] max-w-[335px] lg:max-w-[1200px] bg-gray lg:flex-row lg:justify-center lg:gap-20 w-full mt-[160px] rounded-lg lg:bg-[url('assets/landing/landing-timeline-5-image-desktop.png')] bg-[url('assets/landing/landing-timeline-5-image.png')]">
